      ...
      <nav>
        <div className="cvdown">
          <div className="cv-button">
            <a href="Ayush Vikharankar- Resume.pdf" download className="anchor">
        ...
        <ul className={`menu ${menuOpen ? 'open' : ''}`}>
          ...
          <li>
            <a href="https://wa.me/7208521535" target="_blank" rel="noopener noreferrer">Contact Me</a>
          </li>
          <div className='navlist-btn'>
            <Link className="button-1" to="/projects">
        ...
        <a href="https://github.com/AyushV14" target="_blank" rel="noopener noreferrer">
